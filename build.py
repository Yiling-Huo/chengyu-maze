...
executables = [cx_Freeze.Executable("chengyu-maze.pyw", icon="icon.ico", base=None, target_name='chengyu-maze.exe')]

cx_Freeze.setup(
    name="Chengyu Maze",
    options={"build_exe": {"packages":["pygame","os","csv","random"], "include_msvcr":"True", 
